...
const contactInfo = [
  {
    title: 'Alamat',
    description: 'Jl. Parung Sapi No. 123, Kec. Jasinga, Kab. Bogor, Jawa Barat',
  ...
  <div class="pt-20">
    ...
    <section class="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center space-y-4">
        <h1 class="text-4xl md:text-6xl font-bold text-white animate-fade-in">Hubungi Kami</h1>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 -mt-32 relative z-20">
          <div v-for="info in contactInfo" :key="info.title" class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
            <div :class="['w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform', info.color]">
      ...
      <div class="container mx-auto px-4 md:px-6">
        <div class="grid lg:grid-cols-2 gap-16">
          ...
          <div class="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-100">
            ...
            <p class="text-gray-500 mb-10">Isi formulir di bawah ini dan tim kami akan segera menghubungi Anda.</p>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
              ...
              <div class="space-y-2">
                <label class="text-sm font-semibold text-gray-700 ml-1">Subjek</label>
                <select 
              ...
              <div class="space-y-2">
                <label class="text-sm font-semibold text-gray-700 ml-1">Pesan</label>
                <textarea 
              ...
              >
                <div v-if="submitted" class="bg-emerald-50 text-emerald-700 p-4 rounded-xl text-center font-medium border border-emerald-100">
          ...
          <!-- Map & Extra Info -->
          <div class="space-y-8">
            <div class="bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 h-[450px]">
              <iframe 
            ...
            <div class="bg-primary rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl">
              ...
              <h3 class="text-2xl font-bold mb-4 relative z-10">Waktu Pelayanan</h3>
              <ul class="space-y-4 relative z-10 opacity-90">
                ...
                <li class="flex justify-between items-center text-secondary-light">
                  <span>Minggu</span>
    ...
    <section class="py-24 bg-white">
      <div class="container mx-auto px-4 md:px-6 text-center">
        <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-12">Punya Pertanyaan Lain?</h2>
        <div class="max-w-3xl mx-auto space-y-4">
          <div class="p-6 bg-gray-50 rounded-2xl text-left hover:bg-gray-100 transition-colors cursor-pointer flex justify-between items-center group">
            <span class="font-bold text-gray-800">Bagaimana prosedur pendaftaran santri baru?</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
          </div>
          <div class="p-6 bg-gray-50 rounded-2xl text-left hover:bg-gray-100 transition-colors cursor-pointer flex justify-between items-center group">
            <span class="font-bold text-gray-800">Berapa biaya pendidikan di Nurul Hidayah?</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
          </div>
